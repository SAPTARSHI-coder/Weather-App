...
> **New to this project? Start here.** The `docs/` folder contains a complete beginner-friendly guide to every part of SkyGlass — written in plain English with real-life analogies. No prior coding knowledge assumed.

| # | File | What You Will Learn |
|---|---|---|
| 1 | [01 — Big Picture](./docs/01_big_picture.md) | What problem SkyGlass solves and why it matters |
| 2 | [02 — Full Flow](./docs/02_full_flow.md) | The complete story: search → servers → engines → dashboard |
| 3 | [03 — Engines Explained](./docs/03_engines_explained.md) | All 12 intelligence engines, one-by-one with analogies |
| 4 | [04 — Features Explained](./docs/04_features_explained.md) | APIs, caching, rate limiting, API key security |
| 5 | [05 — Code Walkthrough](./docs/05_code_walkthrough.md) | Every important file's code explained line-by-line |
| 6 | [06 — Real Examples](./docs/06_examples.md) | Mumbai, Delhi, London — watch the system think |
| 7 | [07 — Why Better](./docs/07_why_better.md) | 14-point comparison vs ordinary weather apps |
| 8 | [08 — Viva Summary](./docs/08_viva_summary.md) | Quick-memorize tables, formulas, and key points |
| 9 | [09 — Viva Q&A](./docs/09_viva_questions.md) | 10 likely teacher questions + detailed model answers |
| 10 | [10 — Glossary](./docs/10_glossary.md) | Every technical term explained in plain English (A–Z) |
| — | [Master Index](./docs/00_index.md) | Full docs map + 30-second pitch |
